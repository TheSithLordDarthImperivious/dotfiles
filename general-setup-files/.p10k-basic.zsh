# Generated by Powerlevel10k configuration wizard on 2024-01-26 at 18:03 EST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 37096.
# Wizard options: ascii, lean_8colors, 1 line, sparse, fluent, instant_prompt=verbose.
